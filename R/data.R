...
#'   Nativeness meta data available at \url{https://irma.nps.gov/NPSpecies/Lookup/GetNativenessMetadata};
#'   occurrence meta data available at \url{https://irma.nps.gov/NPSpecies/Lookup/GetOccurrenceMetadata};
